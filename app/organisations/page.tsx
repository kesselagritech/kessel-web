      ...
      <section className="relative bg-forest-dark pt-28 pb-20 overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 text-center">
          ...
          <p className="reveal reveal-delay-2 text-lg text-white/70 max-w-2xl mx-auto mb-8">
            Suivez vos bénéficiaires, collectez des données terrain et générez des rapports professionnels pour vos partenaires financiers.
          </p>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <h2 className="reveal reveal-delay-1 text-3xl md:text-4xl font-bold text-forest-dark" style={{ fontFamily: "var(--serif)" }}>
              Ce que Kessel apporte<br /><em>à votre organisation.</em>
            </h2>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { icon: "M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z", title: "Suivi des bénéficiaires", desc: "Gérez les fiches de tous vos bénéficiaires avec leurs exploitations, cultures et historique complet." },
              { icon: "M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z", title: "Rapports pour bailleurs", desc: "Générez des rapports professionnels avec indicateurs d impact pour vos partenaires financiers." },
              { icon: "M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z", title: "Collecte terrain", desc: "Vos techniciens saisissent les données sur le terrain, même sans connexion internet." },
              { icon: "M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z", title: "Donnees sécurisées", desc: "Vos données sont hébergées de manière sécurisée et conformes aux standards internationaux." },
              ...
              { icon: "M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z", title: "Gain de temps", desc: "Automatisez la collecte et l agregation des données. Fini les tableaux Excel eparpilles." },
            ].map((item, i) => (
      ...
      <section className="py-24 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            {[
              { step: "1", title: "Créez votre programme", desc: "Définissez votre zone d'intervention, les cultures ciblées et vos indicateurs." },
              { step: "2", title: "Invitez vos techniciens", desc: "Ajoutez vos agents terrain et attribuez-leur des zones géographiques." },
              { step: "3", title: "Collectez les données", desc: "Vos techniciens enregistrent les bénéficiaires et font le suivi sur le terrain." },
              { step: "4", title: "Générez vos rapports", desc: "Exportez des rapports professionnels pour vos bailleurs en quelques clics." },
            ].map((item, i) => (
      ...
      <section id="tarifs" className="py-24 bg-neutral">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <h2 className="reveal reveal-delay-1 text-3xl md:text-4xl font-bold text-forest-dark" style={{ fontFamily: "var(--serif)" }}>
              Des plans adaptés<br /><em>à votre structure.</em>
            </h2>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="reveal reveal-delay-1 bg-white p-8 rounded-2xl shadow-sm">
              ...
              <ul className="space-y-3 mb-8">
                {["Jusqu'à 100 bénéficiaires", "3 techniciens", "Mode hors-ligne", "Export Excel", "Rapports standards", "Support email"].map((feature, i) => (
            ...
            <div className="reveal reveal-delay-2 bg-forest-dark p-8 rounded-2xl shadow-lg relative">
              ...
              <ul className="space-y-3 mb-8">
                {["Jusqu'à 500 bénéficiaires", "10 techniciens", "Mode hors-ligne", "Export Excel", "Rapports personnalisés", "Multi-programmes", "1 session de formation", "Support prioritaire"].map((feature, i) => (
            ...
            <div className="reveal reveal-delay-3 bg-white p-8 rounded-2xl shadow-sm">
              ...
              <ul className="space-y-3 mb-8">
                {["Bénéficiaires illimités", "Techniciens illimités", "Tout le plan Pro inclus", "API acces données", "Formations illimitées", "Account manager dédié", "SLA garanti"].map((feature, i) => (
                  <li key={i} className="flex items-center gap-2 text-ink-mid text-sm">
                    <svg className="w-5 h-5 text-forest shrink-0" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                      <polyline points="20 6 9 17 4 12" />
                    </svg>
      ...
      <section className="relative py-24 bg-forest-dark overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-6 text-center">
          <h2 className="reveal text-3xl md:text-5xl font-bold text-white mb-6" style={{ fontFamily: "var(--serif)" }}>
            Prêt à digitaliser<br /><em className="text-amber-light">vos programmes ?</em>
          </h2>
          <p className="reveal reveal-delay-1 text-lg text-white/70 mb-10">
            Contactez-nous pour une démonstration personnalisée et découvrez comment Kessel peut transformer le suivi de vos bénéficiaires.
          </p>
