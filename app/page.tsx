      ...
      <section className="py-24 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              { initials: "JN", name: "Jean-Noël Mboua", role: "Promoteur cacao - Région Sud", quote: "Avant Kessel, je notais tout dans un cahier. Aujourd'hui je sais exactement ma marge sur chaque projet." },
              { initials: "AM", name: "Awa Mbarga", role: "Promotrice maraîchage - Bafoussam", quote: "Les prix marchés m'ont aidé à vendre mes tomates au bon moment. J'ai évité de vendre à perte." },
              { initials: "PF", name: "Paul Fotso", role: "Technicien agricole - Région Ouest", quote: "Je peux soumettre mes observations en temps réel. Le promoteur voit tout instantanément." },
            ].map((testimonial, i) => (
