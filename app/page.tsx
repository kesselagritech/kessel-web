  ...
  return (
    <>
        ...
        <div className="relative z-10 max-w-6xl mx-auto w-full grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h1 className="reveal reveal-delay-1 text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight mb-6" style={{ fontFamily: "var(--serif)" }}>
              Gerez vos projets agricoles <em className="text-amber-light">comme un pro.</em>
            </h1>

            <p className="reveal reveal-delay-2 text-lg text-white/70 mb-8 max-w-lg">
              Kessel est l application mobile qui aide les promoteurs agricoles camerounais a suivre leurs finances, leurs taches, les prix des marches et leurs techniciens.
            </p>
            ...
            <div className="reveal reveal-delay-4 flex gap-8 mt-10 pt-8 border-t border-white/10">
              ...
              <div>
                ...
                <div className="text-white/50 text-sm">speculations</div>
              </div>
              <div>
            ...
            <div className="relative w-[260px] h-[520px] bg-[#0a0a0a] rounded-[2.5rem] p-2 shadow-2xl border border-white/10">
              ...
              <div className="relative w-full h-full bg-forest-dark rounded-[2rem] overflow-hidden flex flex-col">
                ...
                <div className="px-4 pb-2 shrink-0">
                  <p className="text-white/50 text-[9px]">Bonjour, Andre</p>
                ...
                <div className="flex-1 overflow-hidden px-3 pb-14">
                  ...
                  <div className="space-y-2">
                    <div className="bg-white rounded-lg p-2.5">
                      <div className="flex justify-between items-start mb-1.5">
                        <div>
                          ...
                          <p className="text-ink-light text-[8px]">2.5 ha - Region Sud</p>
                        </div>
                      ...
                      <div className="flex gap-3 text-[8px]">
                        ...
                        <div>
                          <p className="text-ink-light">Depenses</p>
                    ...
                    <div className="bg-white rounded-lg p-2.5">
                      <div className="flex justify-between items-start mb-1.5">
                        <div>
                          <p className="text-forest-dark font-semibold text-[11px]">Maraichage Kribi</p>
                    ...
                    <div className="bg-white rounded-lg p-2.5">
                      <div className="flex justify-between items-start mb-1.5">
                        ...
                        <span className="bg-amber-light text-amber-dark text-[7px] px-1.5 py-0.5 rounded-full">En cours</span>
                      </div>
                      <div className="flex gap-3 text-[8px]">
                        <div>
                          <p className="text-ink-light">Revenus</p>
                ...
                <div className="absolute bottom-2 left-2 right-2 bg-white/10 backdrop-blur rounded-xl p-2 flex justify-around">
                  ...
                  <div className="flex flex-col items-center">
                    <svg className="w-4 h-4 text-white/50" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                      ...
                      <path d="M12 8v8m0-8c-1.5 0-3 .8-3 2s1.5 2 3 2 3 .8 3 2-1.5 2-3 2" />
                    </svg>
                  ...
                  <div className="flex flex-col items-center">
                    ...
                    <span className="text-white/50 text-[7px] mt-0.5">Marches</span>
                  </div>
                  <div className="flex flex-col items-center">
                    <svg className="w-4 h-4 text-white/50" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
      ...
      <section id="fonctionnalites" className="py-24 bg-neutral">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            <p className="reveal text-amber font-semibold text-sm uppercase tracking-wider mb-3">Fonctionnalites</p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { icon: "M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z", title: "Suivi financier", desc: "Revenus, depenses, marges. Visualisez la rentabilite de chaque projet en temps reel." },
              { icon: "M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4", title: "Gestion des taches", desc: "Planifiez les activites agricoles, assignez-les a vos techniciens, suivez l avancement." },
              { icon: "M13 7h8m0 0v8m0-8l-8 8-4-4-6 6", title: "Prix des marches", desc: "Consultez les prix actualises des produits agricoles sur les marches camerounais." },
              ...
              { icon: "M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z", title: "Itineraires techniques", desc: "78 fiches ITK detaillees pour guider vos pratiques culturales etape par etape." },
              { icon: "M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064", title: "Adapte au Cameroun", desc: "5 zones agro-ecologiques, 60+ speculations locales, interface en francais et anglais." },
            ].map((feature, i) => (
      ...
      <section className="py-24 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            <p className="reveal text-amber font-semibold text-sm uppercase tracking-wider mb-3">Temoignages</p>
            <h2 className="reveal reveal-delay-1 text-3xl md:text-4xl font-bold text-forest-dark" style={{ fontFamily: "var(--serif)" }}>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              { initials: "JN", name: "Jean-Noel Mboua", role: "Promoteur cacao - Region Sud", quote: "Avant Kessel, je notais tout dans un cahier. Aujourd hui je sais exactement ma marge sur chaque projet." },
              { initials: "AM", name: "Awa Mbarga", role: "Promotrice maraichage - Bafoussam", quote: "Les prix marches m ont aide a vendre mes tomates au bon moment. J ai evite de vendre a perte." },
              { initials: "PF", name: "Paul Fotso", role: "Technicien agricole - Region Ouest", quote: "Je peux soumettre mes observations en temps reel. Le promoteur voit tout instantanement." },
            ].map((testimonial, i) => (
              <div key={i} className={`reveal reveal-delay-${i + 1} bg-forest-light p-8 rounded-2xl`}>
                <div className="text-amber text-xl mb-4">*****</div>
      ...
      <section id="telecharger" className="relative py-24 bg-forest-dark overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-6 text-center">
          <h2 className="reveal text-3xl md:text-5xl font-bold text-white mb-6" style={{ fontFamily: "var(--serif)" }}>
            Commencez a piloter<br />vos projets <em className="text-amber-light">des aujourd hui.</em>
          </h2>
          <p className="reveal reveal-delay-1 text-lg text-white/70 mb-10">
            Application 100% gratuite. Aucune carte bancaire requise. Telechargez et commencez a gerer vos projets agricoles immediatement.
          </p>
