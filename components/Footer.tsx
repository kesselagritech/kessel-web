      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="grid md:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            <Link href="/" className="inline-block mb-4">
              <span className="text-2xl font-bold tracking-[0.02em]" style={{ fontFamily: "var(--serif)" }}>
                <span className="text-white">Kessel</span>
                <span style={{ color: "#E8B84D" }}> Agritech</span>
              </span>
            </Link>
            <p className="text-white/50 text-sm leading-relaxed mb-4">
              Digitalisation et professionnalisation du secteur agricole camerounais.
            </p>
          ...
          {/* Nos outils */}
          <div>
            <h4 className="text-white font-semibold mb-4">Nos outils</h4>
            <ul className="space-y-2 text-sm">
              <li><Link href="/application" className="text-white/60 hover:text-amber transition-colors">Application mobile</Link></li>
              <li><Link href="/bibliotheque" className="text-white/60 hover:text-amber transition-colors">Bibliothèque</Link></li>
              <li><Link href="/comparateur" className="text-white/60 hover:text-amber transition-colors">Comparateur de projets</Link></li>
            </ul>
          </div>
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-4">
            <a href="https://wa.me/237659374501" className="text-white/40 hover:text-amber transition-colors" aria-label="WhatsApp">
